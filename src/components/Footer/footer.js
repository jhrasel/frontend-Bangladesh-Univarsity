  ...
  return(
      <div className={styles.mainFooter}>
          ...
          <Container>
              <Row>
                  <Col md={3} xs={12}>
                      <Image src={BrandIcon.src} alt={'home image'} width={262} height={35} />
                      <p className={styles.text}>
                          Alumni Org is an alumni organisation of the student of University. Organise a lots of events of the betterment of present and ex students of the university.
                      </p>
              ...
              <p style={{border: '1px solid #356655', marginTop: '20px', marginBottom: '20px'}}></p>
