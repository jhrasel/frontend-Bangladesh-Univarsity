  ...
  return (
    <Container className="mainWhyus">
      ...
      <p className="sectionSubtitle">
        Discover What Makes Our Institution Stand Out and Get Competitive Edge
      ...
      >
        {tabData?.data?.body?.length &&
          tabData?.data?.body?.map((item, index) => {
            return (
              <Tab
                key={index}
                eventKey={item?.tab}
