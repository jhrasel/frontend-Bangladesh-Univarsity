                            ...
                            <Row>
                                ...
                                <Col xs={12} md={8} xl={8}>
                                    <div className={styles.card_details}>
                                        ...
                                        <p style={{textTransform: 'capitalize'}}><b>Designation :</b> {FacultyMemberData?.data?.data?.editableRole.replaceAll("_", " ")}</p>
                                        <p style={{textTransform: 'capitalize'}}><b>Phone :</b> {FacultyMemberData?.data?.data?.phone}</p>
                                                                                <p ><b>Email Address :</b> {FacultyMemberData?.data?.data?.email}</p>
                                        <div className="hide">
