              ...
              <div className={styled.navigation}>
                ...
                {/* <div className={styled.inner_navigation}>
                  ...
                  <p className="hide">
                    ...
                    {noticeList?.data?.body?.title &&
                      ` / ${
                        noticeList?.data?.body?.title.length > 30
                          ? noticeList?.data?.body?.title.slice(0, 30) + "..."
                          : noticeList?.data?.body?.title
                      }`}
                  </p>
...
=======
    ...
    return(
        <div>
            ...
            <Addmission />
>>>>>>> 0e3946721cbca545c74a64f648d195dbda317fc1
        </div>
      </Container>
      <Container>
        <div className={styled.topCard}>
          <Card
            style={{ padding: "20px", border: "none", margin: "0" }}
            className="notice_card"
          >
            <p className={styled.title}>
              {moment(noticeList?.data?.body?.updatedAt).format("MMM Do YY")} /
              Research
            </p>
            {/* <h4 className={styled.subtitle}>{noticeList?.data?.body?.description}</h4> */}
            <img
